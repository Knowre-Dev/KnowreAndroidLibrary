 ...
 */
internal class MathConfiguration(private val configuration: Configuration) {
    ...
    var candidateCount by Delegates.observable(2) { _, _, new ->
        configuration.setString("math.configuration.script", "SetMathSymbolCandidateCount $new")
    }
